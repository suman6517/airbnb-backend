...
//        }
    ...
    public List<BookingDto> getAllBookingsByHotelId(Long hotelId)
    {
        ...
        log.info("Getting all bookings for the hotel with hotelId: {}", hotelId);
    ...
    public HotelReportDto getHotelReport(Long hotelId, LocalDate startDate, LocalDate endDate)
    {
        ...
        log.info("Generating the Hotel Report for the hotel with hotelId: {}", hotelId);
        ...
        List<Booking> bookings = bookingRepository.findByHotelAndCreateTimeBetween(hotel , startDateTime, endDateTime);
        ...
        BigDecimal averageRevenue = totalConfirmedBookings == 0 ? BigDecimal.ZERO : totalRevenueOfConfirmedBooking
                .divide(BigDecimal.valueOf(totalConfirmedBookings), RoundingMode.HALF_UP);

        return new   HotelReportDto(totalConfirmedBookings ,totalRevenueOfConfirmedBooking ,averageRevenue);
    }
